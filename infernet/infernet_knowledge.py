...
class InferNetwork_knowledge(object):
    def __init__(self,
    ...
    def respond(self,query):
        ...
        final_out.update({"answer":final_out['choice'],"generator_count":final_out['mc_count'],"raw_answer":final_out['raw_answer'],"gen_n":len(self.generators),"enhance_layer_n":self.enhance_layer_n})
    ...
    def get_answer_poll(self,query):
        ...
        responses = {"full_possible_answer_poll":raw_responses,"full_possible_answer_count":count}
        return responses
